...
docker --context=arm32v7 build -t "${REPO}/${IMAGE}:arm32v7_build" .
...
echo "========== Building arm64 =========="
docker --context=arm64 build -t "${REPO}/${IMAGE}:arm64_build" .
...
docker --context=x86_64 build -t "${REPO}/${IMAGE}:x86_64_build" .
